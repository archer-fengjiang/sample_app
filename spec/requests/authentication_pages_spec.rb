...
describe "Authentication" do
  ...
  describe "signin" do
    ...
    describe "with valid information" do
      ...
      before { sign_in user } # define helper function in spec/support/utilities.rb
  ...
  describe "authroization" do
    ...
    describe "as wrong user" do
      let(:user) { FactoryGirl.create(:user) }
      let(:wrong_user) { FactoryGirl.create(:user, email: "wrong@exmaple.com") }
      before { sign_in user }
